...
function Callbacks:Trigger(event, cb, invoker, ...)
    ...
    TriggerServerEvent("Vaedra:triggerServerCallback", event, self.id, invoker, ...)
...
function Callbacks:ClientRecieve(eventName, requestId, invoker, ...)
    ...
    local returnCb = function(...)
        TriggerServerEvent("Vaedra:clientCallback", requestId, invoker, ...)
    end
...
---@param ... any
---@return nil
function Vaedra.Callback:TriggerServerCallback(eventName, callback, ...)
...
---@param ... any
---@return ...
function Vaedra.Callback:AwaitServerCallback(eventName, ...)
    local invokingResource = GetInvokingResource()
    local invoker = (invokingResource and invokingResource ~= "unknown") and invokingResource or "Vaedra-Core"
...
function Vaedra.Callback:RegisterClientCallback(eventName, callback)
    local invokingResource = GetInvokingResource()
    local invoker = (invokingResource and invokingResource ~= "Unknown") and invokingResource or "Vaedra-Core"
...
---@param eventName string
---@return boolean
function Vaedra.Callback:DoesClientCallbackExist(eventName)
...
RegisterNetEvent("Vaedra:serverCallback")
AddEventHandler("Vaedra:serverCallback", function(...)
    Callbacks:ServerRecieve(...)
end)

RegisterNetEvent("Vaedra:triggerClientCallback")
AddEventHandler("Vaedra:triggerClientCallback", function(...)
